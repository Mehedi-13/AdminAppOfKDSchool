...
public class UploadNotice extends AppCompatActivity {
    ...
    private CardView  addImageForNotice;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        addImageForNotice= findViewById(R.id.addImage);

        addImageForNotice.setOnClickListener(new View.OnClickListener() {
            @Override
        ...
        uploadNoticeButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (noticeTitle.getText().toString().isEmpty()){
                    noticeTitle.setError("Give the Title name");
                }
                else if (bitmap==null){
                    uploadData();
                }
        ...
        uploadTask.addOnCompleteListener(UploadNotice.this, new OnCompleteListener<UploadTask.TaskSnapshot>() {
            ...
            public void onComplete(@NonNull @NotNull Task<UploadTask.TaskSnapshot> task) {
                ...
                if (task.isSuccessful()){
                    ...
                    startActivity(new Intent(UploadNotice.this,Dashboard.class));
                }else {
                    pd.dismiss();
